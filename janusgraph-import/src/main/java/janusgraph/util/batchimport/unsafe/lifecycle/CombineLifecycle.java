        ...
        implements Lifecycle
{
     ...
     * to the state of this CombineLifecycle.
     *
     ...
     * the status of the CombineLifecycle (i.e. if it was started it will remain started)
     */
    ...
    private void toString( int indent, StringBuilder sb )
    {
        ...
        for ( LifecycleInstance instance : instances )
        {
            if ( instance.instance instanceof CombineLifecycle)
            {
                ((CombineLifecycle) instance.instance).toString( indent + 3, sb );
            }
            else
            {
