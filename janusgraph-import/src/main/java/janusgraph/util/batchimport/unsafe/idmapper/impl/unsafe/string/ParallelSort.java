...
import janusgraph.util.batchimport.unsafe.helps.collection.PrimitiveLongStack;
import janusgraph.util.batchimport.unsafe.idmapper.cache.LongArray;
import janusgraph.util.batchimport.unsafe.idmapper.impl.unsafe.string.raddix.Radix;
import janusgraph.util.batchimport.unsafe.idmapper.impl.unsafe.string.raddix.RadixCalculator;
...
import static janusgraph.util.batchimport.unsafe.idmapper.impl.unsafe.string.EncodingIdMapper.clearCollision;
