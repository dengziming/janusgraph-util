...
import static janusgraph.util.batchimport.unsafe.log.FormattedLog.OUTPUT_STREAM_CONVERTER;
...
public class FormattedLogProvider extends AbstractLogProvider<FormattedLog>
{
    ...
    public static class Builder
    {
         ...
         * starts with the specified string will have its level set. For example, setting the level for the context {@code Log}
         * would result in that level being applied to {@link Log}s with the context {@code Foo}, {@code Lo}, etc.
         *
